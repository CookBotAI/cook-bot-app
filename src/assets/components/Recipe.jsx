...
class Recipe extends React.Component {
  ...
  //GET//
  fetchRecipes = async () => {
    axios.get(`${PORT}/recipes`).then((response) => {
  ...
  addRecipe = (ingredients) => {
    // console.log('Im here before post request', ingredients);
  ...
  updateRecipe = async (id, updatedData) => {
    axios.put(`${PORT}/recipes/${id}`, updatedData).then((response) => {
  ...
  deleteRecipe = async (id) => {
    axios.delete(`${PORT}/recipes/${id}`).then((response) => {
